    ...
    <div className="flex flex-col justify-center">
      ...
      <div className="bg-primary flex items-center p-4 mt-5 rounded-lg">
        <div className="flex items-center justify-center bg-white rounded-full w-14 h-14">
          <i className="fa fa-phone-alt text-[#000000] text-2xl"></i>
        </div>
        <div className="ml-4">
          <p className="text-[#000000] text-lg font-medium">Contact Us 24/7</p>
          <h3 className="text-[#000000] text-xl font-bold">+234 7072 2618 83</h3>
        </div>
      </div>
    </div>
