  ...
  const recentReleases = [
    {
      ...
      slug: "recent-1",
      title: "Exploring African Heritage Through Dance",
      date: "May 27, 2025",
      description: "A deep dive into dance as a cultural expression.",
      image: img9
    },
    {
      category: "recent-releases",
      slug: "recent-2",
      title: "Sound of Suburb in Lagos",
      date: "May 27, 2025",
      description: "The rise of grassroots music scenes.",
      image: img12
    },
    {
      category: "recent-releases",
      slug: "recent-3",
      title: "Tech on the Rise in Africa",
      date: "May 27, 2025",
      description: "Highlighting African innovation and start-ups.",
      image: img13
    },
    {
      category: "recent-releases",
      slug: "recent-4",
      title: "Fashion Week New Wave",
      date: "May 27, 2025",
      description: "New trends shaking up African fashion.",
      image: img14
    }
  ];
  ...
  const business = [
    {
      category: "business",
      slug: "biz-1",
      title: "Entrepreneurial Growth in Nigeria",
      date: "May 25, 2025",
      description: "Nigeria’s startup scene is booming.",
      image: img15
    },
    {
      category: "business",
      slug: "biz-2",
      title: "SMEs Driving New Economies",
      date: "May 26, 2025",
      description: "How small businesses shape local markets.",
      image: img16
    },
    {
      category: "business",
      slug: "biz-3",
      title: "Blockchain Startups Rise",
      date: "May 27, 2025",
      description: "A new wave of digital finance.",
      image: img17
    }
  ];
  ...
  const sports = [
    {
      category: "sports",
      slug: "sport-1",
      title: "African Athletes on the World Stage",
      date: "May 25, 2025",
      description: "Stories of determination and global success.",
      image: img25
    },
    {
      category: "sports",
      slug: "sport-2",
      title: "Grassroots Football Revolution",
      date: "May 26, 2025",
      description: "How local games build national pride.",
      image: img24
    },
    {
      category: "sports",
      slug: "sport-3",
      title: "Emerging Basketball Stars",
      date: "May 27, 2025",
      description: "Young athletes shining in Africa.",
      image: img25
    }
  ];
  ...
  const culture = [
    {
      category: "culture",
      slug: "culture-1",
      title: "The Art of Blackness in Motion",
      date: "May 20, 2025",
      description: "Celebrating Black identity through performance.",
      image: img9
    },
    {
      category: "culture",
      slug: "culture-2",
      title: "Afrobeats Evolution",
      date: "May 22, 2025",
      description: "Charting the explosive growth of Afrobeats.",
      image: img27
    },
    {
      category: "culture",
      slug: "culture-3",
      title: "African Storytelling Reimagined",
      date: "May 23, 2025",
      description: "A new era of digital folktales.",
      image: img11
    }
  ];
  ...
  const spotlight = [
    {
      category: "spotlight",
      slug: "spot-1",
      title: "New Soundscape in Shaku Culture",
      date: "May 24, 2025",
      description: "Uncovering rhythmic revolutions.",
      image: img3
    },
    {
      category: "spotlight",
      slug: "spot-2",
      title: "Creative Powerhouses Rising",
      date: "May 25, 2025",
      description: "Artists transforming global media.",
      image: img22
    },
    {
      category: "spotlight",
      slug: "spot-3",
      title: "Fashion and Media Icons",
      date: "May 26, 2025",
      description: "Celebrating industry leaders.",
      image: img10
    }
  ];
    ...
    <div className={`${isGrid ? "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4" : "flex flex-col gap-4"}`}>
      {data.map((item, index) => (
        ...
        to={`/${item.category.toLowerCase()}/${item.slug}`}
          ...
          className={`${
            isGrid
              ? "bg-white rounded shadow hover:shadow-lg transition overflow-hidden"
              : "flex flex-row items-start gap-4 w-full max-w-md bg-white rounded shadow hover:shadow-lg transition overflow-hidden"
          }`}
        >
          <img
            src={item.image}
...
<section className="lg:hidden px-0 mt-0  space-y-6">
      {/* Main Hero Image */}
      <div className="lg:w-3/4 relative rounded overflow-hidden h-[550px] ">
  <img
    src={img4}
    alt="CTDA Media"
    className="w-full h-full object-cover"
